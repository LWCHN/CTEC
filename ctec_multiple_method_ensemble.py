...
if 1:
    ...
    for i in range(0,len(data_list_fullname)):
        ...
        if CTEC_DB==1:
            ...
            ITER_NUMBER = 10
            t0=time.time()
            adata_ctec_db = CTEC_DB_multiple(ADATA_RAW,algo_name,CV_THRESHOLD, ITER_NUMBER,PRINT_INFO=False)
            ...
            if exist_ground_truth_cell_type: 
                acc_ctec_db, acc_results_name = calc_acc.evaluate(ADATA_RAW,'ctec_db_labels',GTname)
        ...
        if CTEC_OB==1:
            ...
            ITER_NUMBER = 10
            t0=time.time()
            adata_ctec_ob = CTEC_OB_multiple(ADATA_RAW,algo_name,ITER_NUMBER,PRINT_INFO=False)
            ...
            if exist_ground_truth_cell_type:
                acc_ctec_ob, acc_results_name = calc_acc.evaluate(ADATA_RAW,'ctec_ob_labels',GTname)
        ...
        if 1:
            ...
            print('___acc: ',algo_name_raw[2])
            print(acc_results_name,acc_algo3)
            ...
            print('___acc: ',algo_name_raw[3])
            print(acc_results_name,acc_algo4)
            ...
            print('___acc: ',algo_name_raw[4])
            print(acc_results_name,acc_algo5)
            ...
            print('___acc: ','SAFE')
            print(acc_results_name,acc_SAFE)
            ...
            print('___acc: ','SAME')
            print(acc_results_name,acc_SAME)
