# -*- coding: utf-8 -*-
"""
docker run --rm -u root -v LOCAL_CTEC_PATH:/ctec_work/:rw lwchn/ctec:v1 bash -c "python /ctec_work/step_all_calc_knownCluster_review2.py --dataset_id 0 --exp_id test_docker_v1_fix_res"
"""
