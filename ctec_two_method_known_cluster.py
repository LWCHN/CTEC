...
def step1(i,N_HIGH_VAR_TEST):
    ...
    #[1.1 read data]
    data_name, data_ext,GTname,class_nums,BATCH_KEY,N_HIGH_VAR,res_leiden,res_louvain = loaddata_KnownCluster(DATASET_NUM)
...
def step2(i,n_neighbors):
    ...
    ## part 1: read and preprocesing
    #[1.1 read data]
    data_name, _,_,_,_,_,_,_ = loaddata_KnownCluster(DATASET_NUM)
...
def step3(i):
    ...
    ## part 1: read and preprocesing
    #[1.1 read data]
    data_name, _,GTname,class_nums,_,_,res_leiden,_ = loaddata_KnownCluster(DATASET_NUM)
    # res_leiden = None
...
def step4(i,n_neighbors):
    ...
    ## part 1: read and preprocesing
    #[1.1 read data]
    data_name, _,GTname,class_nums,_,_,_,res_louvain = loaddata_KnownCluster(DATASET_NUM)
    # res_louvain = None
...
def step5(i):
    ...
    ## part 1: read and preprocesing
    #[1.1 read data]
    data_name, _,GTname,_,_,_,_,_ = loaddata_KnownCluster(DATASET_NUM)
    print('\n\n','='*100)
...
parser.add_argument('--exp_id', type=str, default='demo_known_cluster', required=False, help='experiment id')
parser.add_argument('--base_method_result_path', type=str, default='./base_method_result/two_method_known_cluster', required=False, help='base_method_result_path')
